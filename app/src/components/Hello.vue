  ...
  <div class="hello">
    ...
    <div class="container my-5">
      ...
      <div class="container-fluid skills">
        ...
        <skill cskill="Bootstrap 4" cclass=""></skill>
        ...
        <skill cskill="nginx" cclass="greyish"></skill>
         <skill cskill="UX/UI Design" cclass="greenish"></skill>
